  ...
  return (
    <div className="w-full h-[100vh] flex justify-center items-center">
      ...
      <div className="text-center w-[450px] shadow-xl min-h-[524px] px-[39px] py-[30px]">
        ...
        <form>
          <Input placeholder="Элекронный почта" type="email" className="mb-[20px]" />
          ...
          <div className="flex justify-between mt-[12px]">
            <p className="text-[#000000]">Восстановить пароль</p>
          ...
          <div className="flex justify-between mt-[20px]">
            <Link
              href="#"
              className="flex gap-[4px] border border-[#00000033] w-max rounded-[8px] py-[12px] px-[50px]"
            >
